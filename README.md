...
2. [如何初始化buildenv ------------------- how to init buildenv](./docs/02_how_to_init.md)
3. [如何添加一个新的平台 ----------------- how to add new platform](./docs/03_how_to_add_platform.md)
4. [如何添加一个新的项目 ----------------- how to add new project](./docs/04_how_to_add_project.md)
5. [如何添加一个新的工具 ----------------- how to add new tool](./docs/05_how_to_add_tool.md)
6. [如何添加一个新的三方库 --------------- how to add new port](./docs/06_how_to_add_port.md)
...
9. [如何集成buildenv ---------------------- how to integrate buildenv](./docs/09_how_to_integrate.md)
10. [如何安装一个三方库 ------------------- how to install a port](./docs/10_how_to_install.md)
